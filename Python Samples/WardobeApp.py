#Adapted from Wardobe tutorial by Bukola on Youtube
# https://www.youtube.com/channel/UC-bFgwL_kFKLZA60AiB-CCQ


#Creates an application similar to one seen in the movie Clueless(1995)
#Wardrobe selector using tkinter and Pillow
...
WINDOW_TITLE = 'Cassidy\'s Wardrobe'
WINDOW_WIDTH = 250
WINDOW_HEIGHT = 500
IMG_HEIGHT = 220
IMG_WIDTH = 200
BEIGE_COLOR_HEX = '#B1CEFA'
